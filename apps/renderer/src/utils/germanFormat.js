...
export const formatGermanNumber = (value, decimals = 2) => {
...
export const formatGermanCurrency = (value, decimals = 2) => {
    if (isNaN(value) || !isFinite(value))
        return '0,00 €';
    return new Intl.NumberFormat('de-DE', {
        style: 'currency',
...
export const formatGermanInteger = (value) => {
    if (isNaN(value) || !isFinite(value))
        return '0';
    return new Intl.NumberFormat('de-DE', {
...
export const formatGermanPercent = (value, decimals = 1) => {
    if (isNaN(value) || !isFinite(value))
        return '0,0%';
    return new Intl.NumberFormat('de-DE', {
        style: 'percent',
...
export const formatGermanInputNumber = (value) => {
