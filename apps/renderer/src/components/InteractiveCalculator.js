...
export default function InteractiveCalculator({ initialSystemSize, annualConsumption, roofArea }) {
    ...
    const autarkyBarRef = useRef(null);
    const selfConsumptionBarRef = useRef(null);
