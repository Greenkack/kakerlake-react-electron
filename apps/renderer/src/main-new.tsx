...
const ResultsPage = () => (
  <div className="card">
    ...
    <p>Hier werden die Berechnungsergebnisse angezeigt...</p>
    <div className="grid">
      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<AppLayout />}>
            ...
            {/* Project Routes */}
            <Route path="project/mode" element={<PlaceholderPage title="📊 Anlagenmodus" />} />
            <Route path="project/customer" element={<PlaceholderPage title="👤 Kundendaten" />} />
            <Route path="project/building" element={<PlaceholderPage title="🏢 Gebäudedaten" />} />
            <Route path="project/demand" element={<PlaceholderPage title="⚡ Bedarfsanalyse" />} />
            <Route path="project/needs" element={<PlaceholderPage title="💭 Bedürfnisse" />} />
            <Route path="project/options" element={<PlaceholderPage title="⚙️ Zusatzoptionen" />} />
            
            {/* Calculation Routes */}
            <Route path="calc/solar" element={<PlaceholderPage title="☀️ Solarkalkulator" />} />
            <Route path="calc/heatpump" element={<PlaceholderPage title="🔥 Wärmepumpen-Sim" />} />
            <Route path="calc/results" element={<ResultsPage />} />
